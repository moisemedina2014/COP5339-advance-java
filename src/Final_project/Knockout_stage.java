...
public class Knockout_stage
{
	public static void insert_Knockout_stage(String created_string, String dbName, String team, String opteam) throws Exception
	{
	...
	public static void create_Knockout_stage(String dbName) throws Exception
	{
		...
		if(jdbc.update_db(created_string) == 1)
		{
			System.out.println("\n\n\tThe table Knockout_stages has been created in the database "+dbName+"\n");
		}
		else
		{
			System.out.println("\n\n\tThe table Knockout_stages already exist in the database "+dbName+"\n");
		}
		//System.out.println("database \t "+jdbc.update_db(created_string));
	}

	public static void fill_Knockout_stage_table(String dbName) throws Exception
	{
		...
		for(int g = 0; g < 8; g++)
		{
			...
			for (int i = 0; i < 3 ;i++ )
			{
				...
				for (int j = i; j < 3; j++ )
				{
					...
					insert_Knockout_stage(created_string, dbName, team, opteam);
